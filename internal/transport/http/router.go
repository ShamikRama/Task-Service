...
func NewRouter(
	...
	api.HandleFunc("/templates/create", templateHandler.CreateAndGenerate).Methods(http.MethodPost)
	api.HandleFunc("/templates", templateHandler.List).Methods(http.MethodGet)
	api.HandleFunc("/templates/{id:[0-9]+}", templateHandler.GetByID).Methods(http.MethodGet)
	api.HandleFunc("/templates/{id:[0-9]+}", templateHandler.Update).Methods(http.MethodPut)
	api.HandleFunc("/templates/{id:[0-9]+}", templateHandler.Delete).Methods(http.MethodDelete)
